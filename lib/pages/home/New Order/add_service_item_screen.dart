                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: serviceState.searchQuery != null &&
                          ...
                          ...categoryState.categories.map((category) {
                            return Padding(
                              ...
                              child: FilterChip(
                                ...
                                selected: categoryState.selectedCategory?.id == category.id,
                                selectedColor: _getColorFromCode(category.colorCode),
                                checkmarkColor: Colors.white,
                                onSelected: (_) {
                                  ref.read(categoryProvider.notifier).selectCategory(category);
                                  serviceNotifier.filterByCategory(category.name);
                                },
                              ),
                            );
                          }),
...
Widget _buildEmptyState(ServiceState serviceState) {
  return Center(
    child: Column(
      ...
      children: [
        Icon(
          serviceState.searchQuery != null && serviceState.searchQuery!.isNotEmpty
              ? Icons.search_off
        ...
        if (serviceState.searchQuery != null && serviceState.searchQuery!.isNotEmpty)
          TextButton(
            onPressed: () {
              _searchController.clear();
